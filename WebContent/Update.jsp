...
<form action="" method="post">
	...
	<form action="Update" method="post" >
		USERNAME : <input type="text" name="username" placeholder="Username" value="<%=emp.getName() %>" readonly />
		<br>
		<br> 
		PASSWORD : <input type="text" name="password" placeholder="Password" value="<%=emp.getPassword() %>" />
		<br> 	
		<br> 
